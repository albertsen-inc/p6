package com.albertsen.test;

import com.albertsen.core.utilFunctions.Huffman;
...
public class huffmanTest{
	public static void huffmanTest(){
		...
		int[] freq = hf.generateFreq(initial_string.toCharArray());
		String decompressed = hf.expand(compressed, freq);
